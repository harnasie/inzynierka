...
\begin{minipage}{\linewidth}
    ...
    \centering
    \fbox{\includegraphics[width=0.9\linewidth]{img/kod/imp-getacceptedloc.png}}
\end{minipage}
\\
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.4]{img/imp/welcome.png}}
...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.2\textwidth} % Drugi obraz
        \centering
    ...
    \begin{minipage}{0.2\textwidth} % Trzeci obraz
        \centering
