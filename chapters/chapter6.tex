...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.6]{img/imp/widok-user.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.6]{img/imp/widok-mapa.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.6]{img/imp/widok-ikony.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.70]{img/imp/widok-danger.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.6]{img/imp/widok-telefony.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.15]{img/imp/widok-admin-home.jpg}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.15]{img/imp/widok-dodajkml.jpg}}
