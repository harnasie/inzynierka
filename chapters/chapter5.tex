...
Rozplanowanie działania aplikacji pozwala na przemyślaną implementację wszystkich funkcji. Przed stworzeniem aplikacji należy dokładnie zastanowić się nad najważniejszymi wymaganiami funkcjonalnymi i niefunkcjonalnymi, przypadkami użycia aplikacji, a także zaprojektować model da nych. Przydatne jest także rozpisanie przykładowych scenariuszy, które mogą wystąpić przy korzystaniu z aplikacji przez użytkownika. Wcześniejsze zaprojektowanie przykładowych interfejsów użytkownika pomaga dostosować wygląd systemu do potrzeb grupy docelowej. Poniższy rozdział skupia się na przedstawieniu projektu aplikacji zawierający wszystkie wcześniej wymienione elementy.
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UCD/UCDpowiadomieniaAdmin.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UC/UCkonto.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UC/UCplan.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UC/UCnawigacja.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UCD/UCDhistoria.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UC/UCpomoc.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UC/UCzagrozenie.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/diagramy/UC/UCkrokomierz.jpg}}
