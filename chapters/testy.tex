...
\begin{minipage}{\linewidth}
    ...
    \label{test:login}
    \centering
    \fbox{\includegraphics[width=0.8\linewidth]{img/test/test-login.jpg}}
\end{minipage}
\\
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.5]{img/test/login-wynik.jpg}}
...
\begin{minipage}{\linewidth}
    ...
    \label{test:signup}
    \centering
    \fbox{\includegraphics[width=0.8\linewidth]{img/test/test-signup1.jpg}}\\[1em]
    \fbox{\includegraphics[width=0.8\linewidth]{img/test/test-signup2.jpg}}
\end{minipage}
\\
...
\begin{minipage}{\linewidth}
    ...
    \label{test:map}
    \centering
    \fbox{\includegraphics[width=0.8\linewidth]{img/test/testmap.jpg}}
\end{minipage}
\\
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.3\textwidth} % Pierwszy obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/testmap1.jpg}}
    ...
    \begin{minipage}{0.3\textwidth} % Drugi obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/testmap2.jpg}}
...
\begin{figure}[H]
    \begin{minipage}{0.3\textwidth} % Pierwszy obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/testmap3.jpg}}
    ...
    \begin{minipage}{0.3\textwidth} % Drugi obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/testmap4.jpg}}
    ...
    \begin{minipage}{0.3\textwidth} % Drugi obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/testmap5.jpg}}
...
\indent W sytuacji, gdy użytkownik chce wysłać zgłoszenie, lecz w danym momencie nie ma połączenia z internetem, aplikacja wyświetla powiadomienie o braku połączenia, tak jak na rys. \ref{test:zglos3}. 
...
\begin{figure}[H]
    \begin{minipage}{0.3\textwidth} % Pierwszy obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/testzglosopis.jpg}}
    ...
    \begin{minipage}{0.3\textwidth} % Drugi obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/brakinternetu.jpg}}
    ...
    \begin{minipage}{0.3\textwidth} % Drugi obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/test/braklok.jpg}}
        \caption{Komunikat informujący o braku lokalizacji.}
        \label{test:zglos4}
    \end{minipage}
\end{figure}

\indent Opisany test dowiódł, iż zgłoszenie zostanie wysłane tylko wtedy, gdy użytkownik poda wszystkie wymagane informacje dotyczące zagrożenia oraz będzie miał włączony internet, a~także udostępnioną lokalizację.

\setlength{\fboxrule}{0.5pt}
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.48]{img/test/testdanger.png}}
