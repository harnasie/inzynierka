...
\begin{minipage}{\linewidth}
    ...
    \label{lst:pobierz}
    \centering
    \fbox{\includegraphics[width=0.6\linewidth]{img/kod/imp-ckeckandadd.jpg}}
\end{minipage}\\
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.6]{img/imp/widok-trasa.png}}
...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.32\textwidth} % Pierwszy obraz
        \centering
        \fbox{\includegraphics[width=\linewidth]{img/imp/welcome.png}}
        \caption{Widok początkowy po uruchomieniu aplikacji.}
        \label{widok:home}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth} % Drugi obraz
        \centering
    ...
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth} % Trzeci obraz
        \centering
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth} % Pierwszy obraz
        \centering
        \includegraphics[width=\linewidth]{img/imp/widok-loka.png}
    ...
    \begin{minipage}{0.32\textwidth} % Drugi obraz
        \centering
        \includegraphics[width=\linewidth]{img/imp/widok-marker.png}
    ...
    \begin{minipage}{0.32\textwidth} % Trzeci obraz
        \centering
        \includegraphics[width=\linewidth]{img/imp/widok-pkt.png}
...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.48\textwidth} % Pierwszy obraz
        \centering
        \includegraphics[width=\linewidth]{img/imp/lista_szlakow.png}
        \caption{Lista dostępnych szlaków.}
        \label{widok:wyborszlaku}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth} % Drugi obraz
        \centering
        \includegraphics[width=\linewidth]{img/imp/po-wyborze-z-listy.png}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.15]{img/imp/widok-admin-danger.jpg}}
